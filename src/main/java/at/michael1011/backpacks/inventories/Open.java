package at.michael1011.backpacks.inventories;
...
public class Open {
    ...
    public Open(Player opener, UUID ownerID, String backPack, String name) {
                ...
                try {
                    ...
                    while(rs.next()) {
                        ...
                        if(rs.getBoolean("hasItemMeta")) {
                            ...
                            meta.setLore(Arrays.asList(rs.getString("lore").split("\\s*,\\s*")));
